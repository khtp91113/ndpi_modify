...
badd +1 ndpi_util.h
badd +1 protos.txt
args ndpiReader.c ndpi_util.c ndpi_util.h protos.txt
edit ndpiReader.c
...
silent! normal! zE
let s:l = 1128 - ((0 * winheight(0) + 27) / 54)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 520 - ((16 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
520
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 135 - ((31 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
