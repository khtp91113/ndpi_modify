...
badd +1 ndpi_main.h
badd +602 ndpi_api.h
badd +0 ndpi_typedefs.h
badd +0 ndpi_define.h
badd +0 ndpi_includes.h
badd +0 ~/nDPI/src/lib/ndpi_main.c
args ndpi_main.h ndpi_api.h ndpi_typedefs.h ndpi_define.h ndpi_includes.h
edit ndpi_main.h
...
silent! normal! zE
let s:l = 75 - ((10 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
normal! 052|
tabedit ~/nDPI/src/lib/ndpi_main.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 525 - ((18 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
525
normal! 014|
tabedit ndpi_typedefs.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 863 - ((37 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
863
normal! 08|
tabedit ndpi_define.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
